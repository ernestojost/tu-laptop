    ...
    <div id="login-account-content" class="bg-white">
        ...
        <?php if (!isset($_SESSION['usuario'])): ?>
            ...
            <div class="d-flex flex-column">
                <a href="mis-datos.php" class="btn btn-primary mt-2 font-weight-bold">MIS DATOS</a>
                <?php if ($_SESSION['usuario']['rol'] == "admin"): ?>
                    <a href="crear-productos.php" class="btn btn-success mt-2 font-weight-bold">CREAR PRODUCTOS</a>
                    <a href="crear-categorias.php" class="btn btn-success mt-2 font-weight-bold">CREAR CATEGORIAS</a>
                <?php endif; ?>   
                <a href="cerrar.php" class="btn btn-danger mt-2 font-weight-bold">CERRAR SESIÓN</a>
            </div>
        <?php endif; ?>
    </div>
</div>